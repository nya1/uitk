  ...
  describe(`Given a ${type}Dropdown DropdownList`, () => {
    ...
    describe("When defaultIsOpen", () => {
      (["Space", "Enter"] as const).forEach((key) => {
        specify(
          ...
          () => {
            cy.mount(<DropdownList defaultIsOpen {...props} />);
            cy.get("#test-control").focus();
            cy.realPress(key);
            if (isMultiSelect) {
              cy.get("#test-popup").should("exist");
      ...
      specify(
        ...
        () => {
          cy.mount(<DropdownList {...props} defaultIsOpen />);
          cy.get("#test-control").focus();
          cy.realPress("Escape");
          cy.get("#test-popup").should("not.exist");
      ...
      //       <DropdownList source={testSource} id="test" />
      //     </div>
      //   );
      ...
      specify(
        ...
        () => {
          cy.mount(<DropdownList isOpen {...props} />);
    ...
    describe("When disabled", () => {
      it("Clicking it should not open the menu", () => {
        cy.mount(<DropdownList disabled {...props} />);
