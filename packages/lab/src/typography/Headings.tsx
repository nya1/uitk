import { ReactNode, ElementType, forwardRef, memo } from "react";
...
export const H2 = memo(
  forwardRef<HTMLHeadingElement, HeadingProps>(function H2(
    { children, styleAs, ...rest },
    ref
  ) {
    return (
...
export const H3 = memo(
  forwardRef<HTMLHeadingElement, HeadingProps>(function H3(
    { children, styleAs, ...rest },
    ref
  ) {
    return (
...
export const H4 = memo(
  forwardRef<HTMLHeadingElement, HeadingProps>(function H4(
    { children, styleAs, ...rest },
    ref
  ) {
    return (
